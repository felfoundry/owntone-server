...
evthr_res      evthr_defer(evthr_t * evthr, evthr_cb cb, void *);
...
evthr_t      * evthr_wexit_new(evthr_init_cb, evthr_exit_cb, void * shared);
evthr_pool_t * evthr_pool_wexit_new(int nthreads, evthr_init_cb, evthr_exit_cb, void *);
